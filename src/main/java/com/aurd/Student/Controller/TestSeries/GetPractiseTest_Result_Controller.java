...
public class GetPractiseTest_Result_Controller {
    ...
    public PracticeTest_Result_Response getResult(Get_PracticeTest_Result_Request request){
...
//        ArrayList<QuizQuestionEntity> arrayList = new ArrayList<>();
     ...
     result.setWrongAnswered(wrongAns);
        ...
        PracticeTest_Result_Response response = new PracticeTest_Result_Response();
        if(result!=null){
