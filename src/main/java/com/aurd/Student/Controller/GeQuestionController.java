...
public class GeQuestionController {
...
//                ArrayList<Question_Option_Model> optionList = new ArrayList<>();
                Question_Option_Model model =  getOptions(optionList,Long.parseLong(objects[1].toString()));
                if(model==null){
                    model= new Question_Option_Model();
...
//       }
    ...
    Question_Option_Model getOptions(ArrayList<Question_Option_Model> arrayList, Long quesID){
      Question_Option_Model model = null;
        System.out.println(arrayList.size()+"++++++++++++++++++++++");
      for(int i=0;i<arrayList.size();i++){

          if(arrayList.get(i).getQuestion_id()==quesID){
